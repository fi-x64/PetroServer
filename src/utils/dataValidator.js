...
export const stationValidator = [
    ...
    body('latitude').isInt({ min: -90, max: 90 }).withMessage('Latitude value must be between -90 and 90'),
    body('longtitude').isInt({ min: -180, max: 180 }).withMessage('Longtitude value must be between -180 and 180'),
